  ...
  return (
    <main className="min-h-screen bg-[#0d1420]">
      ...
      <section className="relative w-full overflow-hidden bg-[#0d1420] h-screen min-h-[600px]">
        ...
        <div className="absolute inset-0 z-10 container mx-auto px-5 lg:px-12 h-full flex flex-col justify-end pb-10 sm:pb-14 md:pb-20">
          <Link
            href="/product"
            className="inline-flex items-center gap-2 text-white/60 hover:text-white transition-all mb-5 sm:mb-8 group w-fit"
          >

      ...
      >
        <div className="flex md:grid md:grid-cols-2 lg:grid-cols-5 gap-3 xl:gap-4 px-4 lg:px-6 xl:px-12 md:container md:mx-auto w-max md:w-auto">
          {stats.map((stat, i) => (
            ...
            >
              <div className={`w-12 h-12 lg:w-14 lg:h-14 rounded-full flex items-center justify-center mb-2 ${stat.bgColor}`}>
              ...
              <div className="mt-auto">
                <Link
                  href={stat.link}
                  className="group/btn inline-flex items-center gap-2 text-sky-400 hover:text-sky-300 text-xs font-bold uppercase tracking-wider transition-colors"
                >
                  Learn More
